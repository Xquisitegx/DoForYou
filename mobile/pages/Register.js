...
export default function Register({ navigation }) {
    return (
        <ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{ height: Dimensions.get("window").height }}>
            <View style={stylesheet.style_Mob_Register_Frame}>
                <View style={stylesheet.style_Mob_Register}>
                    <View style={stylesheet.style_Group_123}>
                        <View style={stylesheet.style_Group_120}>
                            <TextInput 
                        ...
                        <View style={[stylesheet.style_First_Name, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_First_Name, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                First Name
                            </Text>
                        </View>
                    </View>
                    <View style={stylesheet.style_Group_127}>
                        <View style={stylesheet.style_Group_120_2}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_2}
                              placeholder=" Required"
                            >
                            </TextInput>
                        </View>
                        <View style={[stylesheet.style_City, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_City, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                City
                            </Text>
                        </View>
                    </View>
                    <View style={stylesheet.style_Group_122}>
                        <View style={stylesheet.style_Group_119}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_3}
                              placeholder=" Required"
                            >
                            </TextInput>
                        </View>
                    ...
                    <View style={stylesheet.style_Group_126}>
                        <View style={stylesheet.style_Group_119_2}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_4}
                              placeholder=" At least 8 characters"
                            >
                            </TextInput>
                        </View>
                        <View style={[stylesheet.style_Password, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Password, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Password
                            </Text>
                        </View>
                    </View>
                    <View style={stylesheet.style_Group_129}>
                        <View style={stylesheet.style_Group_119_3}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_5}
                              placeholder=" Required"
                            >
                            </TextInput>
                        </View>
                        <View style={[stylesheet.style_Address, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Address, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Address
                            </Text>
                        </View>
                    </View>
                    <View style={stylesheet.style_Group_130}>
                        <View style={stylesheet.style_Group_119_4}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_6}
                              placeholder=" Required"
                            >
                            </TextInput>
                        </View>
                        <View style={[stylesheet.style_Postal_Code, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Postal_Code, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Postal Code
                            </Text>
                        </View>
                    </View>
                    <View style={stylesheet.style_Group_125}>
                        <View style={stylesheet.style_Group_119_5}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_7}
                            >
                            </TextInput>
                            <TextInput 
                              style={stylesheet.style_Rectangle_55}
                              placeholder=" +1 (CA)"
                            >
                            </TextInput>
                        </View>
                        <View style={[stylesheet.style_Country, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Country, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Country
                            </Text>
                        </View>
                        <View style={[stylesheet.style_Mobile_Number, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Mobile_Number, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Mobile Number
                            </Text>
                        </View>
                    </View>
                    <View style={stylesheet.style_Group_124}>
                        <View style={stylesheet.style_Group_121}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_8}
                              placeholder=" Required"
                            >
                            </TextInput>
                        </View>
                        <View style={[stylesheet.style_Last_Name, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Last_Name, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Last Name
                            </Text>
                        </View>
                    </View>
                    <View style={stylesheet.style_Group_128}>
                        <View style={stylesheet.style_Group_121_2}>
                            <TextInput 
                              style={stylesheet.style_Rectangle_54_9}
                              placeholder=" Required"
                            >
                            </TextInput>
                        </View>
                        <View style={[stylesheet.style_Province, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Province, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Province
                            </Text>
                        </View>
                    </View>
                    ...
                    >
                        ...
                        <View style={[stylesheet.style_Sign_Up, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                            <Text style={[stylesheet.style_Sign_Up, { position: "relative", flexGrow: 1, left: 0, top: 0, height: 30, transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                                Sign Up
                            </Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    <View style={stylesheet.style_Rectangle_53}>
                    </View>
                    <View style={[stylesheet.style_or, { display: "flex", flexDirection: "row", alignItems: "center" }]}>
                        <Text style={[stylesheet.style_or, { position: "relative", flexGrow: 1, left: 0, top: 0, height: "auto", transform: [{ translateX: 0 }, { translateY: 0 }], }]}>
                            or
                        </Text>
                    </View>
                </View>
